...
export const SWISHY_REGISTRY_0: CompositionDef[] = [
  {
    id: "Swishy2026",
    title: "2026",
  ...
  },
  {
    ...
    icon: "🎬",
    category: "Miscellaneous",
    loadComponent: () => import("../../../Swishy/a-story-about-the-world/Scene").then(m => m.Scene),
    defaultProps: {
        "scene1Word1": "In the",
        "scene1Word2": "beginning",
        "scene2Word1": "SILENCE",
  ...
  },
  {
    ...
    icon: "🎬",
    category: "Miscellaneous",
    loadComponent: () => import("../../../Swishy/animate-characters/Scene").then(m => m.Scene),
    defaultProps: {
        "title": "Magic Horse",
        "subtitle": "A mystical journey",
        "fontFamily": "Roboto",
  ...
  },
  {
    ...
    defaultProps: {
        ...
        "video5": "blob:https://www.swishy.ai/99c2d426-33e8-4adb-af77-7a86c02b062a"
    },
    durationInFrames: 150,
    fps: 30,
    controls: [
