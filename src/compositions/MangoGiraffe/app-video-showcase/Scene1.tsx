...
const SCENE_PARAMS = {
  ...
  video5: { type: "video", label: "Video 5", value: "https://miuzeaacksoumruaqxfv.supabase.co/storage/v1/object/public/input/87922316-72f9-483c-96b3-9d69034eaadc/demo1.mp4" },
};
