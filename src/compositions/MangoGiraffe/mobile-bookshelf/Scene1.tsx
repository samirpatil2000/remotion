...
const SCENE_PARAMS = {
  ...
  referenceImage: { type: "image", label: "Reference Image", value: "https://miuzeaacksoumruaqxfv.supabase.co/storage/v1/object/public/input/17cef1e5-be63-4ec5-a952-8b8522239191/favicon.png" },
